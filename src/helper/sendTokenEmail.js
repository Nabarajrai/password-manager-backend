 ...
 */
export const sendTokenEmail = async (toEmail, username, link,temp_password,temp_pin) => {
    try {
        // Create transporter
   const transporter = nodemailer.createTransport({
    ...
    secure: false, // TLS
    auth: {
        user: "jackblok904@gmail.com",       // Your Gmail address
        pass: "rqbn urar wazi ligg",    // Gmail App Password
    },
    });

        // Email options
        const mailOptions = {
            from: `"Salapa Bikas Bank" <jackblok904@gmail.com>`,
            to: toEmail,
